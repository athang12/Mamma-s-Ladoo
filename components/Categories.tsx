      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
        {categories.map((category) => (
          <Link
            ...
            className="card group cursor-pointer tap-highlight-transparent relative"
            style={{
          ...
          >
            <div className="relative overflow-hidden h-48 sm:h-56 md:h-64">
              ...
              <div 
                ...
                style={{
                  backgroundImage: `linear-gradient(to top, ${theme.colors.primary}99, transparent)`
                }}
              />
              <div className="absolute top-3 right-3 text-3xl bg-white/90 rounded-full w-12 h-12 flex items-center justify-center">
                {theme.images.badge}
              </div>
            ...
            <div className="p-4 sm:p-5 md:p-6">
              <div className="flex items-center justify-between">
                <span 
                  className="text-sm sm:text-base font-semibold bg-gradient-to-r bg-clip-text text-transparent"
                  style={{
